...
export const projects: ProjectType[] = [
  ...
  },
  {
    name: "~/Chatkick",
    description: `
          No início de 2022, a Chatkick (NY - EUA) convidou-me para codificar o design de seu novo site,
          aplicando melhores práticas de programação e SEO. Alcancei resultados notáveis no aumento de visitas.
          Como resultado, fui convidado a liderar a união dos sites comerciais Talent CRM e Chatkick em um único
          domínio - chatkick.com. Minhas habilidades em combinar essas vertentes resultaram no site ativo, proporcionando
  ...
  {
    name: "~/DMT-Domain Management Tool",
    description: `Ao longo de todo o ano de 2022, trabalhei na interface interna do DNS Filter.
  ...
  },
  {
    ...
    description: `No início de 2023, o DNS Filter me convidou para participar do desenvolvimento do back-end do DMT, devido aos cortes do ultimo layoff,
          ...
          `,
    techStack: ["Typescript", "NestJS", "TypeORM", "PostgreSQL", "Cloud - AWS"],
    image: "/images/dns-filter-projects-logo.webp",
    year: "2023",
  },
  {
