  ...
  return (
    <>
      <motion.div
        ...
        className={`absolute -z-50 h-96 w-96  opacity-75 transition-all ease-linear  ${
          isInHeroSection
            ? "shape-1 bg-gradient-to-br from-[#ee0979] to-[#ff6a00]"
            : isInProjectsSection
            ? "shape-2 bg-gradient-to-br from-[#ee0979] to-[#ff6a00]"
            : isInProjetc1Section
            ...
            : "shape-6 bg-gradient-to-br from-[#ee0979] to-[#ff6a00]"
        }`}
      />
    </>
  );
