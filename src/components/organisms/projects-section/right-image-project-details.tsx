...
export interface RightImageProjectDetailsProps {
  project: {
    name: string;
    description: string;
    techs: string[];
...
export default function RightImageProjectDetails({
  project,
}: RightImageProjectDetailsProps) {
      ...
      {isInView && (
        ...
        >
          ...
          >
            ...
            <span className="hover-effect text-lg lg:text-2xl">{project.work}</span>
